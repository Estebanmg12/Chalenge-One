function encriptar() {
  ...
  mostrarResultado(textoOriginal, textoCifrado, "Texto encriptado con éxito", "./img/encriptado.png");
...
function desencriptar() {
  ...
  mostrarResultado(textoEncriptado, textoOriginal, "Texto desencriptado con éxito", "./img/desencriptado.jfif");
  mostrarBotonCopiar(true);
}
